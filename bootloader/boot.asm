...
# in this case the FAT16 filesystem is used
boot_parameter_block:
    pOEM: 		        .ascii "os______" 	# OEM string, has to occupy 8 bytes
    pSectSize: 		    .word 0x200 		# size of sector (in bytes)
